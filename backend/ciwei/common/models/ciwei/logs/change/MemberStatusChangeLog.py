...
class MemberStatusChangeLog(db.Model):
    ...
    stuff_id = db.Column(INTEGER(11, unsigned=True), nullable=False, index=True, default=0, comment="起因举报")
    stuff_type = db.Column(TINYINT(), nullable=False, default=0, index=True, comment="1：物品 0：答谢")
