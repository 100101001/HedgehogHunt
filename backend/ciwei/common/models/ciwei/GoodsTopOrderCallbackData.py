...
@time: 2020/3/22 下午11:25
@file: GoodsTopOrderCallbackData.py
@desc: 
"""
...
class GoodsTopOrderCallbackData(db.Model):
    __tablename__ = 'goods_top_order_callback_data'
    ...
    top_order_id = db.Column(INTEGER(11, unsigned=True), nullable=False, unique=True, index=True, default=0,
                             comment="支付订单id")
